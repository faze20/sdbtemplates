    ...
    return (
        <div className="websites_container">
             <Helmet>
                ...
                content='Mobile App Development Company. We are a leading mobile app
                development agency known for developing  full cycle custom mobile apps for iOS, 
                Android platforms,cross platforms and hybrid systems.'
                />
                <title>Mobile App Development Company - Software Dev Bytes</title>
            </Helmet>
                            ...
                            <div className="dataheader_content">
                                <Fade right>
                                    <div className='dataheader_items'>
                                        <h1 className='clouddatafade_h1'>
                                            Breathing Tech <br />Into Your Ideas
                                        </h1>
                                        <div className='fade_p '>
                                            Success starts with building the right
                                ...
                                <section className="websitecard_container">
                                    <div className="websitecard">
                                        ...
                                        <p>
                                            ...
                                            our dedicated iOS developers have delivered apps to over 100 customers.      
                                        </p>
                                    </div>
                                    <div className="websitecard">
                                    ...
                                    <div className="websitecard">
                                        ...
                                        <p>
                                            ...
                                            and operating systems  your app can be everywhere your users are.                     
                                        </p>
                                    </div>
                                    <div className="websitecard">
