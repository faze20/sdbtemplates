                ...
                <div className="form_content">
                    ...
                    <div className="contain">
                        ...
                        <div className="section2">
                            <div className="section_content">
                                <div className="section_icon"><GitHubIcon />  </div>
                                <button>Sign In With Github</button>
                            </div>
                            <div className="section_content">
                                <div className="section_icon"> <GoogleIcon /> </div>
                                <button>Sign In With Google</button>
                            </div>
                            <div className="section_content">
                                <div className="section_icon"> <FacebookIcon /> </div>
                    ...
                    <div className="not_registered">
                        <div className="terms_condition">
                            <p>
                                ...
                                Facebook, or Apple, you agree to
                                 <Link to="/terms">Softwaredevbytes's Terms of Use </Link> 
