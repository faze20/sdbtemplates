...
function Websites() {
    ...
    return (
        <div className="websites_container">
             <Helmet>
               <meta name='keyword ' content='Wix, shopify,etsy,squarespace,mock-up, custom website'/>
                <meta name='description' 
                content='A top-rated California web development &amp; web design company.Software dev bytes build a
                Responsive, SEO-Optimized Website Designs That Engage &amp; Convert Visitors.'
                />
                <title>Website Development Company - Maximize Your Online Presence</title>
            </Helmet>
                    ...
                    <div className="website_header">
                        <div className="websiteheader_content">
                            <Fade right>
                                ...
                                <p className='fade_p'>
                                    Every user is like a potential buyer or
                        ...
                        <div className="websites_services">
                            ...
                            <section className="websitecard_container">
                                <div className="websitecard">
                                    ...
                                    <p>
                                        We maintain, add new features, optimise images, update deprecated keywords, 
                            ...
                            <div className="websitecard">
                                    ...
                                    <button  type='button' onClick={()=> navigate("/contact")} className='websitecard_button'>Get quote</button>
                                    <p>
                                        We give your customers an awesome website experience regardless of the
                            ...
                            <div className="websitecard">
                                ...
                                <button  type='button' onClick={()=> navigate("/contact")} className='websitecard_button'>Get quote</button>
                                <p>
                                    We develop progressive web app for your business that helps you manage 
                            ...
                            <div className="websitecard">
                                ...
                                <p>
                                    We build professionally designed ,conversion-optimised pages to help you close 
