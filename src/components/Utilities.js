        ...
        <div className="utilities" >
             <Helmet>
               <meta name='Utilities' content='free utility'/>
                <meta name='keyword' content='free seo &amp; website tools'/>
                <meta  name="description" content="free seo tools." />
                <title>Utilities |  Free Top customer-preferred Website tools</title>
            </Helmet>
            ...
            <div className="utility_tools">
                <div className="utility_contents">
                    <div className="seo_tools">
                        ...
                        <div className="seo_items">
                            ...
                            <div className="seo_solcontents">
                                <div>  <AddLinkIcon />  </div>
                                <a href='https://www.semrush.com/features/link-building-and-prospecting-tools/'>
                                    <h4>Free Backlinks List</h4>
                                </a>
                            </div>
                            <div className="seo_solcontents">
                                <img src="backlinkicon.jpg" alt="backlink" />
                                <a href='https://www.semrush.com/features/technical-seo-tools/'> 
                                <h4>SEO Analyzer</h4>
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="seo_tools">
                        ...
                        <div className="seo_items">
                            <div className="seo_solcontents">
                                <div><YouTubeIcon /> </div>
                                <a href='https://ahrefs.com/youtube-keyword-tool'>
                                    <h4>YouTube Keyword Tool</h4>
                                </a>
                            </div>
                            <div className="seo_solcontents">
                                <div> <YoutubeSearchedForIcon /> </div>
                                <a href='https://ahrefs.com/youtube-keyword-tool'>
                                    <h4>YouTube Top Keyword Explorer</h4>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="seo_tools">
                        ...
                        <div className="seo_items">
                            <div className="seo_solcontents">
                                ...
                                <a href='https://zyro.com/ai/content-generator'>
                                    <h4>AI Content Generator</h4>
                                </a>
                            </div>
                            <div className="seo_solcontents">
                                <div> <TuneIcon />  </div>
                                <a href='https://zyro.com/tools/slogan-generator'>
                                    <h4>AI Paragraph Translator</h4>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="seo_tools">
                        ...
                        <div className="seo_items">
                            <div className="seo_solcontents">
                                <div> <ViewComfyIcon /> </div>
                                <a href='https://www.semrush.com/features/technical-seo-tools/'>  
                                    <h4>Programs Explorer</h4>
                                </a>
                            </div>
                            <div className="seo_solcontents">
                                <div> <GpsFixedIcon /> </div>
                                <a href='https://www.softwaredevbytes.com'>
                            ...
                            <div className="seo_solcontents">
                                ...
                                <a href='https://www.softwaredevbytes.com'> 
                                    <h4>High CPC Keywords Explorer</h4>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="seo_tools">
                        ...
                        <div  className="seo_items">
                            <div className="seo_solcontents">
                                ...
                                <a href='https://www.email-validator.net/'>
                                    <h4>Email Validation Tool</h4>
                                </a>
                            </div>
                            <div className="seo_solcontents">
                                <div> <EmailIcon />  </div>
                                <a href='https://www.email-validator.net/'> 
                                    <h4>Bulk Email  Validation</h4>
                                </a>
                            </div>
                            <div className="seo_solcontents">
                                <div> <Filter9PlusIcon /> </div>
                                <a href='https://email-checker.net/email-extractor'> 
                                    <h4>Email Text Extractor</h4>
                                </a>
                            </div>
                            <div className="seo_solcontents">
                                <div> <WebhookIcon /></div>
                                <a href='https://www.visme.co/schedule-maker/'>
                                    <h4>Warmup Schedule Generator</h4>
                                </a>
                            </div>
                        </div>
                    </div> 
                            ...
                            <div className="seo_items">
                                <div className="seo_solcontents">
                                    ...
                                    <a href='https://www.termsfeed.com/privacy-policy-generator/'>
                                        <h4>Privacy Policy Generator Tool</h4>
                                    </a>
                                </div>
                                <div className="seo_solcontents">
                                    <div> <GavelIcon />  </div>
                                    <a href='https://www.termsandconditionsgenerator.com/'>
                                        <h4>Terms &amp; Conditions Generator Tool</h4>
                                    </a>
                                </div>
                                <div className="seo_solcontents">
                                    <div><AirIcon /></div>
                                    <a href='https://scrapestack.com/product?utm_source=Guru99&utm_medium=ThirdParties&utm_content=ScrapeStack-ProductListing'>
                                        <h4>WEB Scrapper</h4>
                                    </a>
                                </div>
                                <div className="seo_solcontents">
                        ...
                        <div className="seo_items">
                            <div className="seo_solcontents">
                                ...
                                <a href='https://www.similarweb.com/'>
                                    <h4>Super Sender License</h4>
                                </a>
                            </div>
                            <div className="seo_solcontents">
                                <div> <LinkIcon /></div>
                                <a href='https://free-url-shortener.rb.gy/'>
                ...
                <div className="adverts">
                    <div className="placeholder">
                        <h4>Place your adverts here  holders </h4>
                        <div className="placeholder_content">
                            <img   src="sdbnew6.png"  alt="adverts"/>
                            <p>Arabian leather</p>
                        </div>
                        <div className="placeholder_content">
                            <img  src="sdbnew6.png"  alt="leather"  />
                            <p>Travel the world.</p>
                        </div>
                        <div className="placeholder_content">
                            <img  src="sdbnew2.png"  alt="content" />
                            <p>Contents.</p>
                        </div>
                        <div className="placeholder_content">
                            <img  src="sdbnew4.png"  alt="refactoring" />
                            <p>Refactorinng.</p>
                        </div>
                        <div className="placeholder_content">
                            <img src="sdbnew5.png"  alt="freelancing"  />
