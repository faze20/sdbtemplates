    ...
    return (
        <div className="websites_container">
             <Helmet>
                ...
                content='Complete Cloud Capabilities: Strategy, Migration, Engineering, Infrastructure &amp; Security
                including servers, storage, databases, networking, software, analytics'
                />
                <title>Data Services Cloud Console |Request A Consultation Today</title>
            </Helmet>
                            ...
                            <div className="dataheader_content">
                                <Fade right>
                                    <div className='dataheader_items'>
                                        ...
                                        <p className='data_p'>
                                            We partner with the world's most valuable 
